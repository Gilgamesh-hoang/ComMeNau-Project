...
//        long amount = 1000000;
        ...
        returnUrlParams.append(ConfigVNPAY.vnp_ReturnUrl).append("?paymentMethod=").append(URLEncoder.encode(invoice.getPaymentMethod(), StandardCharsets.US_ASCII))
//                .append(ConfigVNPAY.vnp_ReturnUrl).append("?action=thanh-toan-vnpay")
